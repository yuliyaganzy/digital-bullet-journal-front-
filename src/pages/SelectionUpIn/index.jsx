        ...
        <div className="min-h-screen w-full bg-[#ebdccb] flex items-center justify-center p-4">
            <div className="w-full max-w-[1440px] max-h-[1024px] flex items-center justify-center rounded-[20px] shadow-lg overflow-visible">
                ...
                <div className="relative w-[640px] h-[864px] flex rounded-l-[20px] overflow-hidden bg-[#f9f9f9]"
                    ...
                    <img src="/images/img_mask_group_hello.svg" alt="Abstract background" className="absolute inset-0 w-full h-full" />
                    <div className="absolute w-[320px] h-[166px] top-[200px] left-[80px]">
                        <h1 className="absolute text-[80px] font-normal font-['Americana_BT'] text-[#2a2a2a] leading-[93px] left-0 top-0">Hello,</h1>
                        <h2 className="absolute text-[80px] font-normal font-['Americana_BT'] text-[#2a2a2a] leading-[93px] left-[90px] top-[92px]">Artist!</h2>
                    </div>
                </div>

                {/* Right Panel */}
                <div className="relative w-[640px] h-[864px] p-10 flex flex-col items-center justify-center rounded-r-[20px] bg-[#f9f9f9]"
                    ...
                    <div className="flex flex-col gap-y-[40px] w-[274px]">
                        ...
                        >
                            <span className="text-[32px] font-[300] font-normal font-montserrat text-[#2a2a2a]">Sign Up</span>
                        </button>
                        <button
                            type="button"
                            ...
                            className="h-[63px] px-24 py-12 border-3 border-[#c3dee1] rounded-[10px] flex items-center justify-center cursor-pointer hover:bg-[#c3dee1] active:scale-95"
                        >
                            <span className="text-[32px] font-[300] font-normal font-montserrat text-[#2a2a2a]">Sign In</span>
                        </button>
                    </div>
